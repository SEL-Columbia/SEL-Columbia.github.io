...
<div class="filter-group">
  ...
  <div class="filter-options" id="filter-countries">
    ...
    {% assign highlight_countries = "United States,Uganda,Ethiopia,Nigeria,Tanzania,Kenya,Senegal,Ghana,Rwanda" | split: "," %}
    ...
    {% for post in site.categories.publications %}
      <li class="publication-item"
        ...
        <div class="pub-meta">
          ...
          {% endfor %}
          {% assign highlight_countries = "United States,Uganda,Ethiopia,Nigeria,Tanzania,Kenya,Senegal,Ghana,Rwanda,Global" | split: "," %}
